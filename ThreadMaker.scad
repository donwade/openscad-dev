...
// print_test (); show me what you got!!

module make_garden_male(length_mm = 25) {
    // tsmthread obeys $fs, $fn, $fa
    $fs=1;
    $fa=1.5;

    // Garden hose, 1 1/16-11.5.
    imperial() 
        //taper(d=1+1/16, h=3/8, off=1/8)
        tsmthread((1+1/16)+$OD_COMP, length_mm/25.4 , 1/11.5, PR=THREAD_NH);
}
